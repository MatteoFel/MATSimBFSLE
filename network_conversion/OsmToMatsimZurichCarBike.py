...
for elem in root.findall('way'):
    ...
    for subelem in elem.findall('tag'):
        ...
        #if str(subelem.get('v'))=="nan":
        #   list[-1][1] = "unknown"
    if list[18][1]=='False' and list[17][1]=='False' and ((list[7][1] == 'no' or list[7][1] == 'nan') and
...
with open('/Users/matteofelder/Documents/IVT/OsmToMatsim/stadt_zh_matsim_car_bike_20_21.xml', 'wb') as f:
