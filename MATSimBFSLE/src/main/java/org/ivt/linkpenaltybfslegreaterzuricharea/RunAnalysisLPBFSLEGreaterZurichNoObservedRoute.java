...
public class RunAnalysisLPBFSLEGreaterZurichNoObservedRoute {
	
	private static final Logger log = Logger.getLogger(RunAnalysisLPBFSLEGreaterZurichNoObservedRoute.class);
	
	/**
	 * generates choice sets, analyses routes according to the AnalysisLPBFSLEGreaterZurich file.
	...
	public static void main(String[] args) throws IOException {
		...
		AnalysisLPBFSLEGreaterZurichNoObservedRoute.analysis(outputPathSetFile, network, ods, nofPaths, variationFactor, nofPaths);
