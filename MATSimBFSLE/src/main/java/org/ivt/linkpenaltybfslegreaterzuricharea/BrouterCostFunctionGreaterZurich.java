...
public class BrouterCostFunctionGreaterZurich implements TravelDisutility, TravelTime {
	
	String[] cost_function_attributes;
	Map<String, Double> attribute_parameters;

	Map<String,Double> used_links;
	
	private static final Logger log = Logger.getLogger(BrouterCostFunctionGreaterZurich.class);
