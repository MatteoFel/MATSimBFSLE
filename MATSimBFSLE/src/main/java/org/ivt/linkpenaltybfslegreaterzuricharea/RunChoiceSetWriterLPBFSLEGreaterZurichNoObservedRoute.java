...
public class RunChoiceSetWriterLPBFSLEGreaterZurichNoObservedRoute {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterLPBFSLEGreaterZurichNoObservedRoute.class);
	
	/**
	 * writes out observed route and alternatives link for link
	 ...
	 *                             inputODFile:       input id|origin|destination tab seperated table (String)
	...
	public static void main(String[] args) throws IOException {
		...
		log.info("variantionFactor:  "+variationFactor);
		...
		Map<String,Tuple<Node,Node>> ods = ParseInputFile.parseODs(inputODFile,network);
		
		// call the choice set writer file which writes to the output file
		ChoiceSetWriterLPBFSLEGreaterZurichNoObservedRoute.choiceSetWriter(outputPathSetFile, network, ods, nofPaths, variationFactor, timeout);
