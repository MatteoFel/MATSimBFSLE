...
public class RunChoiceSetWriterLPBFSLEGreaterZurich {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterLPBFSLEGreaterZurich.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterLPBFSLEGreaterZurich.choiceSetWriter(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, timeout);
