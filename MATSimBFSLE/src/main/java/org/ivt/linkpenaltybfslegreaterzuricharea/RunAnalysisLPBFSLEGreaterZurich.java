...
public class RunAnalysisLPBFSLEGreaterZurich {
	
	private static final Logger log = Logger.getLogger(RunAnalysisLPBFSLEGreaterZurich.class);
	...
	public static void main(String[] args) throws IOException {
		...
		AnalysisLPBFSLEGreaterZurich.analysis(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, nofPaths);
