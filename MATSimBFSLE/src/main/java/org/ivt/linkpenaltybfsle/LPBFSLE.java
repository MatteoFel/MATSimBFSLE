...
* that uses a cost function which may include an additional link penalty.
*/
...
public class LPBFSLE implements ChoiceSetGenerator {
	
	//////////////////////////////////////////////////////////////////////
	// member variables
	//////////////////////////////////////////////////////////////////////
	
	private final static Logger log = Logger.getLogger(LPBFSLE.class);
	 ...
	 */
	private final LinkPenaltyCostFunction cost_function;
	...
	public LPBFSLE(Network network) {
		if (network == null) { throw new RuntimeException("Network must exist."); }
		
		this.network = network;
		cost_function = new LinkPenaltyCostFunction();
