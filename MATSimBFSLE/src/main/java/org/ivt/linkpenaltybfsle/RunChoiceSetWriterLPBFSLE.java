...
public class RunChoiceSetWriterLPBFSLE {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterLPBFSLE.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterLPBFSLE.choiceSetWriter(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, timeout);
