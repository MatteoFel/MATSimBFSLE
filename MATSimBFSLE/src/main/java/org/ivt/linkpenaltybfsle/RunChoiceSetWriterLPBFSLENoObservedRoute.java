...
public class RunChoiceSetWriterLPBFSLENoObservedRoute {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterLPBFSLENoObservedRoute.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterLPBFSLENoObservedRoute.choiceSetWriter(outputPathSetFile, network, ods, nofPaths, variationFactor, timeout);
