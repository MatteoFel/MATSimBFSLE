...
public class RunAnalysisLPBFSLEZurich {
	
	private static final Logger log = Logger.getLogger(RunAnalysisLPBFSLEZurich.class);
	
	/**
	 * generates choice sets, analyses routes according to the AnalysisLPBFSLEZurich file.
	...
	public static void main(String[] args) throws IOException {
		if (args.length != 6) {
			log.error("Usage: RunAnalysisLPBFSLEZurich nofPaths variantionFactor timeout inputNetworkFile inputODFile outputPathSetFile");
		...
		AnalysisLPBFSLEZurich.analysis(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, nofPaths);
