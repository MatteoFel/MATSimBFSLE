...
public class RunChoiceSetWriterLPBFSLEZurich {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterLPBFSLEZurich.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterLPBFSLEZurich.choiceSetWriter(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, timeout);
