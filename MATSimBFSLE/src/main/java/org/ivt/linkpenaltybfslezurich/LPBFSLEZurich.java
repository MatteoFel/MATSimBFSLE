...
* that uses a cost function which may include an additional link penalty, and is specific to the city of Zurich example
...
public class LPBFSLEZurich implements ChoiceSetGenerator {
	
	//////////////////////////////////////////////////////////////////////
	// member variables
	//////////////////////////////////////////////////////////////////////
	
	private final static Logger log = Logger.getLogger(LPBFSLEZurich.class);
	 ...
	 */
	private final BrouterCostFunctionZurich cost_function;
	...
	public LPBFSLEZurich(Network network) {
		if (network == null) { throw new RuntimeException("Network must exist."); }
		
		this.network = network;
		cost_function = new BrouterCostFunctionZurich();
	...
	/**
	 * set up dictionary: at the start the choice set is empty and each link has been used zero times.
	 */
