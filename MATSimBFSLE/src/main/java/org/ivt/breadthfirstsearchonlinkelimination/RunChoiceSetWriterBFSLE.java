...
public class RunChoiceSetWriterBFSLE {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterBFSLE.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterBFSLE.choiceSetWriter(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, timeout);
