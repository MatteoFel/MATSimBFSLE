...
public class RunAnalysisBFSLE {
	
	private static final Logger log = Logger.getLogger(RunAnalysisBFSLE.class);
	...
	public static void main(String[] args) throws IOException {
		...
		AnalysisBFSLE.analysis(outputPathSetFile, network, ods_chosenRoutes, nofPaths, variationFactor, nofPaths);
