...
public class RunChoiceSetWriterBFSLENoObservedRoute {
	
	private static final Logger log = Logger.getLogger(RunChoiceSetWriterBFSLENoObservedRoute.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ChoiceSetWriterBFSLENoObservedRoute.choiceSetWriter(outputPathSetFile, network, ods, nofPaths, variationFactor, timeout);
